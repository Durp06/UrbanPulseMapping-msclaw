...
export async function getTreesInRadius(
  ...
  let query = sql`
    SELECT
      ...
      t.species_genus as "speciesGenus",
      t.species_confidence as "speciesConfidence",
      t.condition_structural as "conditionStructural",
      t.condition_leaf as "conditionLeaf",
      t.health_status as "healthStatus",
      t.health_confidence as "healthConfidence",
      t.observations,
      t.estimated_dbh_cm as "estimatedDbhCm",
      t.estimated_dbh_in as "estimatedDbhIn",
      t.estimated_height_m as "estimatedHeightM",
      t.estimated_height_ft as "estimatedHeightFt",
      t.estimated_crown_width_m as "estimatedCrownWidthM",
      t.estimated_crown_width_ft as "estimatedCrownWidthFt",
      t.num_stems as "numStems",
